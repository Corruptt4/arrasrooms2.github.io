...
class Gun {
    constructor(body, info) {
        ...
        if (info.PROPERTIES != null && info.PROPERTIES.COLOR_OVERRIDE != null) this.colorOverride = info.PROPERTIES.COLOR_OVERRIDE
...
class Entity {
    ...
    define(set) {
        ...
        if (set.FOLLOW_PLAYER != null) {
          this.settings.followPlayer = set.FOLLOW_PLAYER
        }
    ...
    confinementToTheseEarthlyShackles() {
        ...
        if (room.gameMode === 'tdm' && this.type !== 'food') {
            ...
            if (room.isIn("boss", loc) && this.team !== -100) this.kill();
