...
const bossRush = (function() {
    let bossTypes = [Class.elite_destroyer, Class.elite_gunnet, Class.elite_sprayer, Class.skimboss, Class.nestKeeper];
    let celestials = [Class.zaphkiel, Class.paladin, Class.freyja];
    const finalBosses = [Class.kronos];
    ...
    function spawnWave() {
        ...
        if (!wave) {
            ...
            if (util.dateCheck("12/23/2022", "01/01/2023")) {
