...
function generateWaves() {
    let bosses = [Class.elite_destroyer, Class.elite_gunner, Class.elite_sprayer, Class.elite_battleship, Class.palisade, Class.skimboss, Class.summoner, Class.nestKeeper, Class.thedisease, Class.zaphkiel, Class.paladin, Class.enyo, Class.freyja, Class.fiolnir, Class.alviss, Class.tyr, Class.xukmes, Class.ragnarok, Class.kronos].sort(() => 1.25 - Math.random());
    let waves = [];
    for (let i = 0; i < 69; i++) {
        let wave = [];
